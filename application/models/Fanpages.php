...
class Model_Fanpages extends Model_DbTable_Fanpages
{
	...
	public function getFacebookInteractionsGraph($fanpageId, $time, $graph){
		...
		if ($graph){
			...
			switch($time){
				case 'month':
					$select = "select a.type, a.post_id, a.facebook_user_id, f.fan_name, f.fan_gender,  a.post_message, a.post_type, a.picture, a.link, a.post_description, a.post_caption, post_message2, a.created_time from (
							SELECT 'post' as type, post_id, facebook_user_id, post_message, post_type, picture, link, post_description, post_caption,post_message as post_message2, created_time  FROM fancrank.posts
					...
					p.post_description as post_description, p.post_caption as post_caption,post_message as post_message2, c.created_time  FROM fancrank.comments c
					...
					l.post_type,
					p.picture as picture, p.link as link, p.post_description as post_description, p.post_caption as post_caption, post_message as post_message2,
					l.created_time
				...
				case 'week':
					$select = "
							select a.type, a.post_id, a.facebook_user_id, f.fan_name, f.fan_gender,  a.post_message, a.post_type, a.picture, a.link, a.post_description, a.post_caption,post_message2, a.created_time from (
							SELECT 'post' as type, post_id, facebook_user_id, post_message, post_type, picture, link, post_description, post_caption,post_message as post_message2, created_time  FROM fancrank.posts
