...
class Model_DbTable_InsightsTrafficPageExternal extends Fancrank_Db_Table
{

    protected $_name = 'Insights_Traffic_Page_External';
    ...
    protected $_metadata = array(
        'insights_id' => array(
            'SCHEMA_NAME' => null,
            'TABLE_NAME' => 'Insights_Traffic_Page_External',
    ...
    protected $_rowClass = 'Model_DbTable_Row_InsightsTrafficPageExternal';

    protected $_rowsetClass = 'Model_DbTable_Rowset_InsightsTrafficPageExternal';
