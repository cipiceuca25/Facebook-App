...
class Model_DbTable_InsightsImpressionsContent extends Fancrank_Db_Table
{

    protected $_name = 'Insights_Impressions_Content';
    ...
    protected $_metadata = array(
        'insights_id' => array(
            'SCHEMA_NAME' => null,
            'TABLE_NAME' => 'Insights_Impressions_Content',
    ...
    protected $_rowClass = 'Model_DbTable_Row_InsightsImpressionsContent';

    protected $_rowsetClass = 'Model_DbTable_Rowset_InsightsImpressionsContent';
