...
class Model_DbTable_ActiveUsers extends Application_Db_Table
{
    ...
    protected $_rowClass = 'Model_DbTable_Row_ActiveUsers';

    protected $_rowsetClass = 'Model_DbTable_Rowset_ActiveUsers';
