...
class Model_DbTable_InsightsImpressionsPage extends Fancrank_Db_Table
{

    protected $_name = 'Insights_Impressions_Page';
    ...
    protected $_metadata = array(
        'insights_id' => array(
            'SCHEMA_NAME' => null,
            'TABLE_NAME' => 'Insights_Impressions_Page',
    ...
    protected $_rowClass = 'Model_DbTable_Row_InsightsImpressionsPage';

    protected $_rowsetClass = 'Model_DbTable_Rowset_InsightsImpressionsPage';
