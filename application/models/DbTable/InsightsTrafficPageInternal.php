...
class Model_DbTable_InsightsTrafficPageInternal extends Fancrank_Db_Table
{
    ...
    protected $_metadata = array(
        'insights_id' => array(
            'SCHEMA_NAME' => null,
            'TABLE_NAME' => 'Insights_Traffic_Page_Internal',
    ...
    protected $_rowClass = 'Model_DbTable_Row_InsightsTrafficPageInternal';

    protected $_rowsetClass = 'Model_DbTable_Rowset_InsightsTrafficPageInternal';
