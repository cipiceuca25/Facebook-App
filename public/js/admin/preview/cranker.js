...
function popover(x) {
	$.ajax({
		type : "GET",
		url : serverUrl + '/admin/preview/popoverprofile/' + fanpageId
...
function choosebadges(){
	...
	$.ajax({
		type : "GET",
		url : serverUrl + '/admin/preview/choosebadges/' + fanpageId,
		dataType : "html",
		cache : false,
		async : true,
		beforeSend: function(){
...
function userProfile(user, load) {
	...
	$.ajax({
		type : "GET",
		url : serverUrl + '/admin/preview/userprofile/' + fanpageId + '/?target='
				+ user,
		dataType : "html",
		cache : false,
		async : true,
...
function getUpcomingBadges(ui, limit){
	...
	$.ajax({
		type : "GET",
		url : serverUrl + '/admin/preview/upcomingbadges/' + fanpageId + '/?limit='
...
function getFeedComment(ui, post_id, type, total, toggle, latest, filter, popup) {
	...
	$.ajax({
		type : "GET",
		url : serverUrl + '/admin/preview/fancrankfeedcomment/' + fanpageId + 
				'?post_id=' + post_id + 
				'&post_type=' + type + 
...
function popup_post(post_id, load) {
	...
	$.ajax({
		type : "GET",
		url : serverUrl + '/admin/preview/popuppost/' + fanpageId + '?post_id='
				+ post_id,
		dataType : "html",
		cache : false,
		async : true,
...
function getNewsfeed() {
	$.ajax({
		type : "GET",
		url : serverUrl + '/admin/preview/newsfeed/' + fanpageId
...
function getTopPost() {
	...
	$.ajax({
		type : "GET",
		url : serverUrl + '/admin/preview/gettoppost/' + fanpageId,
		dataType : "html",
		cache : false,
		async : true,
		beforeSend: function(){
...
function getFancrankfeed(view) {
	...
	//alert(serverUrl + '/admin/preview/fancrankfeed/' + fanpageId + '?viewAs='+ view + '&limit=' + feedLimit);
	//alert(setFeed);
	//alert(feedLimit);
	//if (view != 'myfeed'){
	//	myfeedoffset = 0;
	...
	$.ajax({
		type : "GET",
		url : serverUrl + '/admin/preview/fancrankfeed/' + fanpageId + '?viewAs='
				+ view + '&until=' + last ,
		dataType : "html",
		cache : false,
		async :  true,
...
function getTopFan() {
	...
	$.ajax({
		type : "GET",
		url : serverUrl + '/admin/preview/topfan/' + fanpageId + '?facebook_user_id='
				+ userId,
		dataType : "html",
		cache : false,
		async : true,
...
function getLeaderboard() {
	...
	$.ajax({
		type : "GET",
		url : serverUrl + '/admin/preview/leaderboard/' + fanpageId
				+ '?facebook_user_id=' + userId,
		dataType : "html",
		cache : false,
		async : true,
...
function getTopList(list, ui){
	$.ajax({
		type : "GET",
		url : serverUrl + '/admin/preview/toplist/' + fanpageId
...
function getMyProfile() {
	$.ajax({
		type : "GET",
		url : serverUrl + '/admin/preview/myprofile/' + fanpageId
				+ '?facebook_user_id=' + userId,
		dataType : "html",
		cache : false,
		async : true,
...
function getRedeem() {
	$.ajax({
		type : "GET",
		url : serverUrl + '/admin/preview/redeem/' + fanpageId + '?facebook_user_id='
				+ userId,
		dataType : "html",
		cache : false,
		async : true,
...
function getpointlog(){
	...
	$.ajax({
		type : "GET",
		url : serverUrl + '/admin/preview/pointlog/' + fanpageId,
		dataType : "html",
		cache : false,
		async : true,
		beforeSend: function(){
...
function getupcomingbadges_notifier(){
	...
	$.ajax({
		type : "GET",
		url : serverUrl + '/admin/preview/upcomingbadges/' + fanpageId + '/?limit=3&notifier=true',
		dataType : "html",
		cache : false,
		async : true,
		beforeSend: function(){
...
function getBadgeNotification(){
	...
	$.ajax({
		type : "GET",
		url : serverUrl + '/admin/preview/badgesnotification/' + fanpageId,
		dataType : "html",
		cache : false,
		async : false,
		beforeSend: function(){
...
function getRecentActivities(ui, user_id) {
	...
	$.ajax({
		type : "GET",
		url : serverUrl + '/admin/preview/recentactivities/' + fanpageId + '?userid=' + user_id + '&source=' + x,
		dataType : "html",
		cache : false,
		async : true,
		beforeSend: function(){
...
function getAllActivities() {
	...
	$.ajax({
		type : "GET",
		url : serverUrl + '/admin/preview/allactivities/' + fanpageId ,
		dataType : "html",
		cache : false,
		async : true,
		beforeSend: function(){
...
function getLikesList(postid, limit, load) {
	...
	$.ajax({
		type : "GET",
		url : serverUrl + '/admin/preview/getlikeslist/' + fanpageId + '?post_id='
				+ postid + '&limit=' + limit,
		dataType : "html",
		cache : false,
		async : true,
...
function getFollowingList(targetname, target, limit, load) {
	...
	$.ajax({
		type : "GET",
		url : serverUrl + '/admin/preview/getfollowing/' + fanpageId + '?limit='
...
function getFollowersList(targetname, target, limit, load) {
	...
	$.ajax({
		type : "GET",
		url : serverUrl + '/admin/preview/getfollowers/' + fanpageId + '?limit='
				+ limit + '&target=' + target + '&targetname=' + targetname
				+ '&mini=0',
		dataType : "html",
		cache : false,
...
function getMiniFollowingList(targetname, target) {
	$.ajax({
		type : "GET",
		url : serverUrl + '/admin/preview/getfollowing/' + fanpageId
...
function getMiniFollowersList(targetname, target) {
	...
	$.ajax({
		type : "GET",
		url : serverUrl + '/admin/preview/getfollowers/' + fanpageId
						+ '?limit=5' + '&target=' + target + '&targetname='
						+ targetname + '&mini=1',
		dataType : "html",
		cache : false,
...
function getAwards() {
	$.ajax({
		type : "GET",
		url : serverUrl + '/admin/preview/awards/' + fanpageId + '?facebook_user_id='
				+ userId,
		dataType : "html",
		cache : false,
		async : true,
